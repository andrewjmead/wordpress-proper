 ...
 */
class PeriodicallyTest extends \WP_UnitTestCase
{
    public function test_should_run_by_default()
    {
        $should_verify_database = Periodically::check('database_last_verified_at', 'PT5S');
    ...
    public function test_accepts_date_interval()
    {
        ...
        $should_verify_database = Periodically::check('database_last_verified_at', $interval);
